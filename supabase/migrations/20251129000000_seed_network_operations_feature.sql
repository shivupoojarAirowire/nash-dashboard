-- Enable Network Operations feature for all users
-- This migration adds the Network Operations feature to the feature_access table
...
values ('Network Operations', true)
on conflict (feature_name) do nothing;

-- Enable Network Operations for all users
...
where not exists (
  ...
  where ufa.user_id = auth.users.id 
    and ufa.feature_name = 'Network Operations'
);
